...
| 版本 | 说明 | 下载链接 |
|------|------|----------|
| **v2.8.2** | 修复充电提醒不工作的问题：充电状态监测独立于电量提醒主开关，支持开机初始化充电状态避免误触发；优化二维码导入流程：去掉选择相机/相册的中间弹窗直接进入扫码页，移除扫描页面紫色方框，扫描完成后预览解析内容确认后再导入，支持从相册选取二维码图片导入；二维码数据压缩优化，支持更大配置量的二维码生成 | [Releases](https://github.com/jinghong-me/smsforwarder.cn/releases) |
