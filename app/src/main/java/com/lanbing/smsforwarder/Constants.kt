...
object Constants {
    ...
    // 内容过滤（全局黑白名单，JSON 数组字符串存储）
    const val PREF_CONTENT_WHITELIST = "content_whitelist"
    const val PREF_CONTENT_BLACKLIST = "content_blacklist"
    ...
    const val PREF_CHARGING_REMINDER_ENABLED = "charging_reminder_enabled"
